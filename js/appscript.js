    ...
    gameDetails = document.createElement("section");
            ...
            <div class="additionalImagesWrapper">
                ...
                <div class="gameplayImagesWrapper">
                    <div class="imageWrapper"><i class="far fa-eye"></i><img src="${gameData[clickedId].logoLink}" alt="Outriders-logo" border="0" class="gameplayImage"></div>
                    <div class="imageWrapper"><i class="far fa-eye"></i><img src="${gameData[clickedId].gameplayLinks[0]}" alt="Outriders-gameplay-3" border="0" class="gameplayImage"></div>
                    <div class="imageWrapper"><i class="far fa-eye"></i><img src="${gameData[clickedId].gameplayLinks[1]}" alt="Outriders-gameplay-2" border="0" class="gameplayImage"></div>
                    <div class="imageWrapper"><i class="far fa-eye"></i><img src="${gameData[clickedId].gameplayLinks[2]}" alt="Outriders-gameplay-1" border="0" class="gameplayImage"></div>
                    <div class="imageWrapper"><i class="far fa-eye"></i><img src="${gameData[clickedId].gameplayLinks[3]}" alt="Outriders-gameplay-4" border="0" class="gameplayImage"></div>
                </div>
            </div>
